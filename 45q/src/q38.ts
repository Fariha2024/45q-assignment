...
function describe_city(city1: string,country: string = "pakistan"){
    return `${city1} is in ${country}`
 };
let city1:string = describe_city(`sawat`);
let city2:string = describe_city(`karachi`);
let city3:string = describe_city(`lahore`);
