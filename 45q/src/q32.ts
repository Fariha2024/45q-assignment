...
let current_users:string[] = [`Ali`,`Riaz`,`Hasan`,`Sara`,`Fatima`];
let new_users:string[] = [`fariha`,`ali`,`qazi`,`fatima`,`kareem`]; 

let current_users_lowercase:string[] = current_users.map(element => 
element.toLowerCase());
